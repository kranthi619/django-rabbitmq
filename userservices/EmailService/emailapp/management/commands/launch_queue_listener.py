...
# Replace with real email sending logic (Django Email backend or external provider)
print(f"[EmailService] Simulating sending welcome email to {user_data.get('email')}")
...
print('[EmailService] Failed to decode message')
return
...
print('[EmailService] Waiting for messages...')
...
print('[EmailService] Listener crashed:', e)
time.sleep(5)
